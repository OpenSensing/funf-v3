...
public class NameValueDatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(String.format("insert into %s (%s, %s, %s, %s, %s) values ('%s', '%s', %s, '%s', %d)", 
				FILE_INFO_TABLE.name, 
				COLUMN_DATABASE_NAME, COLUMN_INSTALLATION, COLUMN_DEVICE_ID, COLUMN_UUID, COLUMN_CREATED,
				databaseName, installationUuid, deviceId, fileUuid, createdTime));
	}
