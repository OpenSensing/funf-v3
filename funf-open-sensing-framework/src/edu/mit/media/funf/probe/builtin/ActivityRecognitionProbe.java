...
public class ActivityRecognitionProbe extends Probe implements ActivityRecognitionKeys, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void sendProbeData() {
        ...
        if (mostRecentData != null) {
            List activities = (List)mostRecentData.get("ACTIVITY");
            Log.d(TAG, "Most recent data len: " + Integer.toString(activities.size()));
    ...
    public void onConnected(Bundle arg0) {
        if (clientAction.equals("ADD")) {
            // Request continuous activity updates
            ActivityRecognition.ActivityRecognitionApi.requestActivityUpdates(mGoogleApiClient, DETECTION_INTERVAL_MILLISECONDS, createRequestPendingIntent());
            Log.i(TAG, "Activity recognition api started");
