...
public abstract class Probe extends CustomizedIntentService implements BaseProbeKeys {
	...
	*/
	...
	/**
	 * This function is obsolete, replaced with packageHasRequiredPermissions
	 * @param context
	 * @param packageName
	 * @return
	 */
	...
	/**
	 * This is the updated version of the function. Instead of polling the full list of all apps and all their permissions, 
	 * it just compares the list of permission of a given package with the list of required permissions
	 * @param context
	 * @param packageName
	 * @param requiredPermissions
	 * @return <tt>false</tt> if one or more of the permissions are missing, <tt>true</tt> if all permissions are granted
	 */
	private static boolean packageHasRequiredPermissions(Context context, String packageName, String[] requiredPermissions) {
